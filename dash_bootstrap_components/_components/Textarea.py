...
- maxrows (string | number; optional):
    Defines the maximum number of rows up to which the autosizing
    textarea can grow.
...
- minrows (string | number; optional):
    Defines the minimum number of rows to show for autosizing
    textarea.
...
- resize (boolean; optional):
    Allows the textarea height to be vertically resizable. If
    autosizing, height is not resizable.
